...
function conicConformalRaw(y06, y12) {
  ...
  function project(x4, y4) {
    if (f > 0) {
      if (y4 < -halfPi4 + epsilon7) y4 = -halfPi4 + epsilon7;
    } else {
      if (y4 > halfPi4 - epsilon7) y4 = halfPi4 - epsilon7;
    }
...
function count2(node) {
  var sum4 = 0, children4 = node.children, i = children4 && children4.length;
  if (!i) sum4 = 1;
  else while (--i >= 0) sum4 += children4[i].value;
  node.value = sum4;
}
...
function sum_default(value) {
  return this.eachAfter(function(node) {
    var sum4 = +value(node.data) || 0, children4 = node.children, i = children4 && children4.length;
    while (--i >= 0) sum4 += children4[i].value;
    node.value = sum4;
  });
}
...
function encloseBasis3(a4, b, c6) {
  var x12 = a4.x, y12 = a4.y, r1 = a4.r, x22 = b.x, y22 = b.y, r2 = b.r, x32 = c6.x, y32 = c6.y, r3 = c6.r, a22 = x12 - x22, a32 = x12 - x32, b23 = y12 - y22, b33 = y12 - y32, c22 = r2 - r1, c32 = r3 - r1, d1 = x12 * x12 + y12 * y12 - r1 * r1, d2 = d1 - x22 * x22 - y22 * y22 + r2 * r2, d3 = d1 - x32 * x32 - y32 * y32 + r3 * r3, ab4 = a32 * b23 - a22 * b33, xa = (b23 * d3 - b33 * d2) / (ab4 * 2) - x12, xb = (b33 * c22 - b23 * c32) / ab4, ya = (a32 * d2 - a22 * d3) / (ab4 * 2) - y12, yb = (a22 * c32 - a32 * c22) / ab4, A5 = xb * xb + yb * yb - 1, B3 = 2 * (r1 + xa * xb + ya * yb), C3 = xa * xa + ya * ya - r1 * r1, r = -(Math.abs(A5) > 1e-6 ? (B3 + Math.sqrt(B3 * B3 - 4 * A5 * C3)) / (2 * A5) : C3 / B3);
  return {
    x: x12 + xa + xb * r,
    y: y12 + ya + yb * r,
    r
...
function powish(transform2) {
  var scale2 = transform2(identity3, identity3), exponent3 = 1;
  function rescale() {
...
function calendar(ticks2, tickInterval, year, month, week, day, hour, minute, second2, format2) {
  ...
  scale2.nice = function(interval3) {
    ...
    return interval3 ? domain(nice2(d, interval3)) : scale2;
  };
  scale2.copy = function() {
...
function pie_default() {
  ...
  function pie(data) {
    var i, n = (data = array_default4(data)).length, j, k2, sum4 = 0, index3 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da2 = Math.min(tau7, Math.max(-tau7, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da2) / n, padAngle.apply(this, arguments)), pa = p * (da2 < 0 ? -1 : 1), v2;
    for (i = 0; i < n; ++i) {
...
function zoom_default2() {
  ...
  function mousedowned(event, ...args) {
    ...
    var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v2 = select_default7(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default3(event, currentTarget), x06 = event.clientX, y06 = event.clientY;
    nodrag_default2(event.view);
  ...
  function dblclicked(event, ...args) {
    if (!filter5.apply(this, arguments)) return;
    var t03 = this.__zoom, p02 = pointer_default3(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t03.invert(p02), k1 = t03.k * (event.shiftKey ? 0.5 : 2), t13 = constrain(translate(scale2(t03, k1), p02, p1), extent2.apply(this, args), translateExtent);
    noevent_default4(event);
