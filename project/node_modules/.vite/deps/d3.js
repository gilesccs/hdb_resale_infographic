...
function blurf(radius) {
  ...
  return (T, S, start3, stop, step) => {
    ...
    for (let i = start3, j = stop; i <= j; i += step) {
      ...
      T[i] = (sum3 + t * (S[Math.max(start3, i - s1)] + S[Math.min(stop, i + s1)])) / w;
...
function ticks(start3, stop, count3) {
  ...
  const reverse2 = stop < start3, [i1, i2, inc2] = reverse2 ? tickSpec(stop, start3, count3) : tickSpec(start3, stop, count3);
  if (!(i2 >= i1)) return [];
...
function tickStep(start3, stop, count3) {
  stop = +stop, start3 = +start3, count3 = +count3;
  const reverse2 = stop < start3, inc2 = reverse2 ? tickIncrement(stop, start3, count3) : tickIncrement(start3, stop, count3);
...
function quickselect(array5, k2, left2 = 0, right2 = Infinity, compare) {
  k2 = Math.floor(k2);
  left2 = Math.floor(Math.max(0, left2));
  right2 = Math.floor(Math.min(array5.length - 1, right2));
  if (!(left2 <= k2 && k2 <= right2)) return array5;
  ...
  while (right2 > left2) {
    if (right2 - left2 > 600) {
      ...
      quickselect(array5, k2, newLeft, newRight, compare);
    }
    const t = array5[k2];
    let i = left2;
    let j = right2;
    swap(array5, left2, k2);
...
function axis(orient, scale) {
  ...
  function axis2(context) {
    var values = tickValues == null ? scale.ticks ? scale.ticks.apply(scale, tickArguments) : scale.domain() : tickValues, format2 = tickFormat2 == null ? scale.tickFormat ? scale.tickFormat.apply(scale, tickArguments) : identity_default : tickFormat2, spacing = Math.max(tickSizeInner, 0) + tickPadding, range4 = scale.range(), range0 = +range4[0] + offset, range1 = +range4[range4.length - 1] + offset, position = (scale.bandwidth ? center : number2)(scale.copy(), offset), selection4 = context.selection ? context.selection() : context, path2 = selection4.selectAll(".domain").data([null]), tick = selection4.selectAll(".tick").data(values, scale).order(), tickExit = tick.exit(), tickEnter = tick.enter().append("g").attr("class", "tick"), line = tick.select("line"), text = tick.select("text");
...
function merge_default(selection4) {
  if (!(selection4 instanceof Selection)) throw new Error("invalid merge");
...
function hsl2(hue2) {
  return function(start3, end) {
    var h = hue2((start3 = hsl(start3)).h, (end = hsl(end)).h), s2 = nogamma(start3.s, end.s), l = nogamma(start3.l, end.l), opacity = nogamma(start3.opacity, end.opacity);
    return function(t) {
      start3.h = h(t);
      start3.s = s2(t);
      start3.l = l(t);
...
function lab2(start3, end) {
  var l = nogamma((start3 = lab(start3)).l, (end = lab(end)).l), a4 = nogamma(start3.a, end.a), b = nogamma(start3.b, end.b), opacity = nogamma(start3.opacity, end.opacity);
  return function(t) {
    start3.l = l(t);
    start3.a = a4(t);
    start3.b = b(t);
...
function hcl2(hue2) {
  return function(start3, end) {
    var h = hue2((start3 = hcl(start3)).h, (end = hcl(end)).h), c6 = nogamma(start3.c, end.c), l = nogamma(start3.l, end.l), opacity = nogamma(start3.opacity, end.opacity);
    return function(t) {
      start3.h = h(t);
      start3.c = c6(t);
      start3.l = l(t);
...
function cubehelix2(hue2) {
  return function cubehelixGamma(y4) {
    ...
    function cubehelix3(start3, end) {
      var h = hue2((start3 = cubehelix(start3)).h, (end = cubehelix(end)).h), s2 = nogamma(start3.s, end.s), l = nogamma(start3.l, end.l), opacity = nogamma(start3.opacity, end.opacity);
      return function(t) {
        start3.h = h(t);
        start3.s = s2(t);
...
var ENDING = 5;
var ENDED = 6;
function schedule_default(node, name, id3, index3, group2, timing) {
...
function interrupt_default(node, name) {
  ...
  if (empty6) delete node.__transition;
}
...
function selectAll_default5(select) {
  ...
  for (var groups2 = this._groups, m3 = groups2.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        for (var children4 = select.call(node, node.__data__, i, group2), child, inherit3 = get2(node, id3), k2 = 0, l = children4.length; k2 < l; ++k2) {
          if (child = children4[k2]) {
            schedule_default(child, name, id3, k2, children4, inherit3);
          }
        }
...
var Selection3 = selection_default2.prototype.constructor;
function selection_default3() {
...
function styleMaybeRemove(id3, name) {
  ...
  return function() {
    var schedule = set3(this, id3), on = schedule.on, listener = schedule.value[key] == null ? remove4 || (remove4 = styleRemove3(name)) : void 0;
...
function transition(name) {
  return selection_default2().transition(name);
}
function newId() {
  return ++id;
}
var selection_prototype = selection_default2.prototype;
...
selection_default2.prototype.interrupt = interrupt_default2;
selection_default2.prototype.transition = transition_default2;
...
function brush(dim) {
  var extent2 = defaultExtent, filter5 = defaultFilter, touchable = defaultTouchable, keys = true, listeners = dispatch_default("start", "brush", "end"), handleSize = 6, touchending;
  function brush2(group2) {
    ...
    overlay.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", cursors.overlay).merge(overlay).each(function() {
      var extent3 = local3(this).extent;
      select_default4(this).attr("x", extent3[0][0]).attr("y", extent3[0][1]).attr("width", extent3[1][0] - extent3[0][0]).attr("height", extent3[1][1] - extent3[0][1]);
    });
  ...
  brush2.move = function(group2, selection4, event) {
    if (group2.tween) {
  ...
  function redraw() {
    var group2 = select_default4(this), selection4 = local3(this).selection;
    if (selection4) {
      group2.selectAll(".selection").style("display", null).attr("x", selection4[0][0]).attr("y", selection4[0][1]).attr("width", selection4[1][0] - selection4[0][0]).attr("height", selection4[1][1] - selection4[0][1]);
  ...
  function started(event) {
    ...
    var that = this, type2 = event.target.__data__.type, mode2 = (keys && event.metaKey ? type2 = "overlay" : type2) === "selection" ? MODE_DRAG : keys && event.altKey ? MODE_CENTER : MODE_HANDLE, signX = dim === Y ? null : signsX[type2], signY = dim === X ? null : signsY[type2], state = local3(that), extent3 = state.extent, selection4 = state.selection, W = extent3[0][0], w0, w1, N = extent3[0][1], n0, n1, E2 = extent3[1][0], e0, e1, S = extent3[1][1], s0, s1, dx = 0, dy = 0, moving, shifting = signX && signY && keys && event.shiftKey, lockX, lockY, points = Array.from(event.touches || [event], (t) => {
    ...
    e1 = e0;
    s1 = s0;
    var group2 = select_default4(that).attr("pointer-events", "none");
    var overlay = group2.selectAll(".overlay").attr("cursor", cursors[type2]);
    if (event.touches) {
      emit.moved = moved;
      emit.ended = ended;
    } else {
      var view = select_default4(event.view).on("mousemove.brush", moved, true).on("mouseup.brush", ended, true);
    ...
    function moved(event2) {
      for (const p of event2.changedTouches || [event2]) {
        for (const d of points)
          if (d.identifier === p.identifier) d.cur = pointer_default2(p, that);
      }
    ...
    function ended(event2) {
      ...
      if (state.selection) selection4 = state.selection;
      if (empty4(selection4)) state.selection = null, redraw.call(that);
  ...
  brush2.filter = function(_) {
    return arguments.length ? (filter5 = typeof _ === "function" ? _ : constant_default5(!!_), brush2) : filter5;
  };
...
function contours_default() {
  ...
  function isorings(values, value, callback) {
    ...
    function stitch(line) {
      var start3 = [line[0][0] + x4, line[0][1] + y4], end = [line[1][0] + x4, line[1][1] + y4], startIndex = index3(start3), endIndex = index3(end), f, g;
...
function arrayAll3(select) {
  return function() {
    return array4(select.apply(this, arguments));
  };
}
...
function style_default4(name, value, priority) {
  return arguments.length > 1 ? this.each((value == null ? styleRemove4 : typeof value === "function" ? styleFunction4 : styleConstant4)(name, value, priority == null ? "" : priority)) : styleValue3(this.node(), name);
}
...
var root3 = [null];
function Selection4(groups2, parents) {
  this._groups = groups2;
  this._parents = parents;
}
function selection3() {
  return new Selection4([[document.documentElement]], root3);
}
...
var selection_default4 = selection3;

// node_modules/d3/node_modules/d3-selection/src/select.js
function select_default7(selector) {
  return typeof selector === "string" ? new Selection4([[document.querySelector(selector)]], [document.documentElement]) : new Selection4([[selector]], root3);
}

// node_modules/d3/node_modules/d3-selection/src/create.js
function create_default3(name) {
  return select_default7(creator_default3(name).call(document.documentElement));
}
...
function pointers_default3(events, node) {
  ...
  return Array.from(events, (event) => pointer_default3(event, node));
}

// node_modules/d3/node_modules/d3-selection/src/selectAll.js
function selectAll_default7(selector) {
  return typeof selector === "string" ? new Selection4([document.querySelectorAll(selector)], [document.documentElement]) : new Selection4([array4(selector)], root3);
}
...
function nodrag_default2(view) {
  var root5 = view.document.documentElement, selection4 = select_default7(view).on("dragstart.drag", noevent_default3, nonpassivecapture);
  if ("onselectstart" in root5) {
    selection4.on("selectstart.drag", noevent_default3, nonpassivecapture);
  } else {
    root5.__noselect = root5.style.MozUserSelect;
    root5.style.MozUserSelect = "none";
  }
...
function yesdrag2(view, noclick) {
  var root5 = view.document.documentElement, selection4 = select_default7(view).on("dragstart.drag", null);
  if (noclick) {
    selection4.on("click.drag", noevent_default3, nonpassivecapture);
    setTimeout(function() {
      selection4.on("click.drag", null);
    }, 0);
  }
...
function drag_default2() {
  var filter5 = defaultFilter2, container = defaultContainer, subject = defaultSubject, touchable = defaultTouchable2, gestures = {}, listeners = dispatch_default4("start", "drag", "end"), active = 0, mousedownx, mousedowny, mousemoving, touchending, clickDistance2 = 0;
  ...
  function mousedowned(event, d) {
    ...
    if (!gesture) return;
    select_default7(event.view).on("mousemove.drag", mousemoved, nonpassivecapture).on("mouseup.drag", mouseupped, nonpassivecapture);
  ...
  function mouseupped(event) {
    select_default7(event.view).on("mousemove.drag mouseup.drag", null);
  ...
  function beforestart(that, container2, event, d, identifier, touch) {
    var dispatch3 = listeners.copy(), p = pointer_default3(touch || event, container2), dx, dy, s2;
    ...
    return function gesture(type2, event2, touch2) {
      ...
      switch (type2) {
        ...
        case "drag":
          p = pointer_default3(touch2 || event2, container2), n = active;
          break;
      }
      dispatch3.call(
        type2,
  ...
  drag.filter = function(_) {
    return arguments.length ? (filter5 = typeof _ === "function" ? _ : constant_default9(!!_), drag) : filter5;
  };
...
function collide_default(radius) {
  ...
  if (typeof radius !== "function") radius = constant_default10(radius == null ? 1 : +radius);
  function force() {
...
function link_default(links) {
  var id3 = index2, strength = defaultStrength, strengths, distance = constant_default10(30), distances, nodes, count3, bias, random, iterations2 = 1;
  if (links == null) links = [];
...
function manyBody_default() {
  var nodes, node, random, alpha, strength = constant_default10(-30), strengths, distanceMin2 = 1, distanceMax2 = Infinity, theta2 = 0.81;
  function force(_) {
...
function radial_default(radius, x4, y4) {
  ...
  if (typeof radius !== "function") radius = constant_default10(+radius);
  if (x4 == null) x4 = 0;
  if (y4 == null) y4 = 0;
  function force(alpha) {
...
function x_default2(x4) {
  ...
  if (typeof x4 !== "function") x4 = constant_default10(x4 == null ? 0 : +x4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
  ...
  force.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default10(+_), initialize(), force) : x4;
  };
  return force;
}
...
function y_default2(y4) {
  ...
  if (typeof y4 !== "function") y4 = constant_default10(y4 == null ? 0 : +y4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
  ...
  force.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default10(+_), initialize(), force) : y4;
  };
  return force;
}
...
function rotationIdentity(lambda, phi2) {
  if (abs3(lambda) > pi5) lambda -= Math.round(lambda / tau6) * tau6;
  return [lambda, phi2];
}
...
function circleRadius(cosRadius, point6) {
  ...
  return ((-point6[2] < 0 ? -radius : radius) + tau6 - epsilon6) % tau6;
}
function circle_default() {
  var center2 = constant_default11([0, 0]), radius = constant_default11(90), precision = constant_default11(2), ring, rotate, stream = { point: point6 };
  ...
  circle.center = function(_) {
    return arguments.length ? (center2 = typeof _ === "function" ? _ : constant_default11([+_[0], +_[1]]), circle) : center2;
  };
  circle.radius = function(_) {
    return arguments.length ? (radius = typeof _ === "function" ? _ : constant_default11(+_), circle) : radius;
  };
  circle.precision = function(_) {
    return arguments.length ? (precision = typeof _ === "function" ? _ : constant_default11(+_), circle) : precision;
  };
  return circle;
}
...
function polygonContains_default(polygon, point6) {
  ...
  var sum3 = new Adder();
  if (sinPhi === 1) phi2 = halfPi4 + epsilon6;
  else if (sinPhi === -1) phi2 = -halfPi4 - epsilon6;
...
function compareIntersection(a4, b) {
  return ((a4 = a4.x)[0] < 0 ? a4[1] - halfPi4 - epsilon6 : halfPi4 - a4[1]) - ((b = b.x)[0] < 0 ? b[1] - halfPi4 - epsilon6 : halfPi4 - b[1]);
}
...
function circle_default2(radius) {
  ...
  function clipLine(stream) {
    ...
    return {
      ...
      point: function(lambda, phi2) {
        var point1 = [lambda, phi2], point22, v = visible(lambda, phi2), c6 = smallRadius ? v ? 0 : code(lambda, phi2) : v ? code(lambda + (lambda < 0 ? pi5 : -pi5), phi2) : 0;
  ...
  function intersect2(a4, b, two) {
    ...
    var delta2 = lambda12 - lambda04, polar = abs3(delta2 - pi5) < epsilon6, meridian = polar || delta2 < epsilon6;
    if (!polar && phi12 < phi02) z = phi02, phi02 = phi12, phi12 = z;
    if (meridian ? polar ? phi02 + phi12 > 0 ^ q[1] < (abs3(q[0] - lambda04) < epsilon6 ? phi02 : phi12) : phi02 <= q[1] && q[1] <= phi12 : delta2 > pi5 ^ (lambda04 <= q[0] && q[0] <= lambda12)) {
    ...
    function polygonInside() {
      ...
      for (var i = 0, n = polygon.length; i < n; ++i) {
        for (var ring2 = polygon[i], j = 1, m3 = ring2.length, point7 = ring2[0], a0, a1, b03 = point7[0], b13 = point7[1]; j < m3; ++j) {
          ...
          if (a1 <= y12) {
            if (b13 > y12 && (b03 - a0) * (y12 - a1) > (b13 - a1) * (x06 - a0)) ++winding;
          } else {
            if (b13 <= y12 && (b03 - a0) * (y12 - a1) < (b13 - a1) * (x06 - a0)) --winding;
          }
        }
...
function resample(project, delta2) {
  function resampleLineTo(x06, y06, lambda04, a0, b03, c0, x12, y12, lambda12, a1, b13, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a4 = a0 + a1, b = b03 + b13, c6 = c0 + c1, m3 = sqrt(a4 * a4 + b * b + c6 * c6), phi2 = asin(c6 /= m3), lambda22 = abs3(abs3(c6) - 1) < epsilon6 || abs3(lambda04 - lambda12) < epsilon6 ? (lambda04 + lambda12) / 2 : atan2(b, a4), p = project(lambda22, phi2), x22 = p[0], y22 = p[1], dx2 = x22 - x06, dy2 = y22 - y06, dz = dy * dx2 - dx * dy2;
...
function mercatorProjection(project) {
  ...
  function reclip() {
    var k2 = pi5 * scale(), t = m3(rotation_default(m3.rotate()).invert([0, 0]));
...
function conicConformalRaw(y06, y12) {
  ...
  function project(x4, y4) {
    if (f > 0) {
      if (y4 < -halfPi4 + epsilon6) y4 = -halfPi4 + epsilon6;
    } else {
      if (y4 > halfPi4 - epsilon6) y4 = halfPi4 - epsilon6;
    }
...
function count2(node) {
  var sum3 = 0, children4 = node.children, i = children4 && children4.length;
  if (!i) sum3 = 1;
  else while (--i >= 0) sum3 += children4[i].value;
  node.value = sum3;
}
...
function eachBefore_default(callback, that) {
  var node = this, nodes = [node], children4, i, index3 = -1;
  while (node = nodes.pop()) {
    callback.call(that, node, ++index3, this);
...
function eachAfter_default(callback, that) {
  var node = this, nodes = [node], next = [], children4, i, n, index3 = -1;
  while (node = nodes.pop()) {
    next.push(node);
    if (children4 = node.children) {
...
function sum_default(value) {
  return this.eachAfter(function(node) {
    var sum3 = +value(node.data) || 0, children4 = node.children, i = children4 && children4.length;
    while (--i >= 0) sum3 += children4[i].value;
    node.value = sum3;
  });
}
...
function encloseBasis3(a4, b, c6) {
  var x12 = a4.x, y12 = a4.y, r1 = a4.r, x22 = b.x, y22 = b.y, r2 = b.r, x32 = c6.x, y32 = c6.y, r3 = c6.r, a22 = x12 - x22, a32 = x12 - x32, b23 = y12 - y22, b33 = y12 - y32, c22 = r2 - r1, c32 = r3 - r1, d1 = x12 * x12 + y12 * y12 - r1 * r1, d2 = d1 - x22 * x22 - y22 * y22 + r2 * r2, d3 = d1 - x32 * x32 - y32 * y32 + r3 * r3, ab = a32 * b23 - a22 * b33, xa = (b23 * d3 - b33 * d2) / (ab * 2) - x12, xb = (b33 * c22 - b23 * c32) / ab, ya = (a32 * d2 - a22 * d3) / (ab * 2) - y12, yb = (a22 * c32 - a32 * c22) / ab, A5 = xb * xb + yb * yb - 1, B2 = 2 * (r1 + xa * xb + ya * yb), C2 = xa * xa + ya * ya - r1 * r1, r = -(Math.abs(A5) > 1e-6 ? (B2 + Math.sqrt(B2 * B2 - 4 * A5 * C2)) / (2 * A5) : C2 / B2);
  return {
    x: x12 + xa + xb * r,
    y: y12 + ya + yb * r,
    r
...
function pack_default() {
  ...
  pack.padding = function(x4) {
    return arguments.length ? (padding = typeof x4 === "function" ? x4 : constant_default12(+x4), pack) : padding;
  };
  return pack;
}
...
function packChildrenRandom(padding, k2, random) {
  return function(node) {
    if (children4 = node.children) {
      ...
      if (r) for (i = 0; i < n; ++i) children4[i].r += r;
...
function executeShifts(v) {
  var shift = 0, change = 0, children4 = v.children, i = children4.length, w;
  while (--i >= 0) {
    w = children4[i];
    w.z += shift;
    w.m += shift;
...
function tree_default() {
  ...
  function firstWalk(v) {
    var children4 = v.children, siblings = v.parent.children, w = v.i ? siblings[v.i - 1] : null;
    if (children4) {
      executeShifts(v);
...
function treemap_default() {
  ...
  treemap.paddingInner = function(x4) {
    return arguments.length ? (paddingInner = typeof x4 === "function" ? x4 : constant_default12(+x4), treemap) : paddingInner;
  };
  ...
  treemap.paddingTop = function(x4) {
    return arguments.length ? (paddingTop = typeof x4 === "function" ? x4 : constant_default12(+x4), treemap) : paddingTop;
  };
  treemap.paddingRight = function(x4) {
    return arguments.length ? (paddingRight = typeof x4 === "function" ? x4 : constant_default12(+x4), treemap) : paddingRight;
  };
  treemap.paddingBottom = function(x4) {
    return arguments.length ? (paddingBottom = typeof x4 === "function" ? x4 : constant_default12(+x4), treemap) : paddingBottom;
  };
  treemap.paddingLeft = function(x4) {
    return arguments.length ? (paddingLeft = typeof x4 === "function" ? x4 : constant_default12(+x4), treemap) : paddingLeft;
  };
  return treemap;
}
...
function powish(transform2) {
  var scale = transform2(identity3, identity3), exponent3 = 1;
  function rescale() {
    return exponent3 === 1 ? transform2(identity3, identity3) : exponent3 === 0.5 ? transform2(transformSqrt, transformSquare) : transform2(transformPow(exponent3), transformPow(1 / exponent3));
  }
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function ticks2(start3, stop, count3) {
    ...
    const interval3 = count3 && typeof count3.range === "function" ? count3 : tickInterval(start3, stop, count3);
    const ticks3 = interval3 ? interval3.range(start3, +stop + 1) : [];
...
function arc_default() {
  ...
  function arc() {
    var buffer, r, r0 = +innerRadius.apply(this, arguments), r1 = +outerRadius.apply(this, arguments), a0 = startAngle.apply(this, arguments) - halfPi5, a1 = endAngle.apply(this, arguments) - halfPi5, da = abs4(a1 - a0), cw = a1 > a0;
    if (!context) context = buffer = path2();
    if (r1 < r0) r = r1, r1 = r0, r0 = r;
    if (!(r1 > epsilon7)) context.moveTo(0, 0);
    else if (da > tau7 - epsilon7) {
...
function pie_default() {
  var value = identity_default5, sortValues = descending_default, sort2 = null, startAngle = constant_default13(0), endAngle = constant_default13(tau7), padAngle = constant_default13(0);
  function pie(data) {
    var i, n = (data = array_default4(data)).length, j, k2, sum3 = 0, index3 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da = Math.min(tau7, Math.max(-tau7, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da) / n, padAngle.apply(this, arguments)), pa = p * (da < 0 ? -1 : 1), v;
    for (i = 0; i < n; ++i) {
...
function nap2() {
  var t03, t13 = taskHead2, t22, time2 = Infinity;
  while (t13) {
    if (t13._call) {
      if (time2 > t13._time) time2 = t13._time;
      t03 = t13, t13 = t13._next;
      ...
      t22 = t13._next, t13._next = null;
      t13 = t03 ? t03._next = t22 : taskHead2 = t22;
    }
  }
  taskTail2 = t03;
  sleep2(time2);
...
var emptyOn2 = dispatch_default4("start", "end", "cancel", "interrupt");
var emptyTween2 = [];
var CREATED2 = 0;
var SCHEDULED2 = 1;
var STARTING2 = 2;
...
var ENDING2 = 5;
var ENDED2 = 6;
function schedule_default2(node, name, id3, index3, group2, timing) {
  var schedules = node.__transition;
  if (!schedules) node.__transition = {};
  else if (id3 in schedules) return;
  create2(node, id3, {
...
function attr_default5(name, value) {
  var fullname = namespace_default3(name), i = fullname === "transform" ? interpolateTransformSvg : interpolate_default3;
...
function attrTweenNS2(fullname, value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0) t03 = (i0 = i) && attrInterpolateNS2(fullname, i);
    return t03;
  }
  tween._value = value;
  return tween;
...
function attrTween2(name, value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0) t03 = (i0 = i) && attrInterpolate2(name, i);
    return t03;
  }
  tween._value = value;
  return tween;
...
function selectAll_default8(select) {
  ...
  for (var groups2 = this._groups, m3 = groups2.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        for (var children4 = select.call(node, node.__data__, i, group2), child, inherit3 = get4(node, id3), k2 = 0, l = children4.length; k2 < l; ++k2) {
          if (child = children4[k2]) {
            schedule_default2(child, name, id3, k2, children4, inherit3);
          }
        }
        subgroups.push(children4);
        parents.push(node);
...
var Selection5 = selection_default4.prototype.constructor;
...
function styleMaybeRemove2(id3, name) {
  var on0, on1, listener0, key = "style." + name, event = "end." + key, remove4;
  return function() {
    var schedule = set5(this, id3), on = schedule.on, listener = schedule.value[key] == null ? remove4 || (remove4 = styleRemove5(name)) : void 0;
    if (on !== on0 || listener0 !== listener) (on1 = (on0 = on).copy()).on(event, listener0 = listener);
    schedule.on = on1;
  };
}
...
function textTween2(value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0) t03 = (i0 = i) && textInterpolate2(i);
    return t03;
  }
  tween._value = value;
  return tween;
...
var id2 = 0;
function Transition2(groups2, parents, name, id3) {
  this._groups = groups2;
  this._parents = parents;
  this._name = name;
  this._id = id3;
...
function transition2(name) {
  return selection_default4().transition(name);
}
function newId2() {
  return ++id2;
}
var selection_prototype2 = selection_default4.prototype;
...
function transition_default4(name) {
  ...
  for (var groups2 = this._groups, m3 = groups2.length, j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        schedule_default2(node, name, id3, i, group2, timing || inherit2(node, id3));
      }
    }
  }
  return new Transition2(groups2, this._parents, name, id3);
}

// node_modules/d3/node_modules/d3-transition/src/selection/index.js
selection_default4.prototype.interrupt = interrupt_default4;
selection_default4.prototype.transition = transition_default4;
...
function zoom_default2() {
  var filter5 = defaultFilter3, extent2 = defaultExtent2, constrain = defaultConstrain, wheelDelta = defaultWheelDelta, touchable = defaultTouchable3, scaleExtent = [0, Infinity], translateExtent = [[-Infinity, -Infinity], [Infinity, Infinity]], duration = 250, interpolate = zoom_default, listeners = dispatch_default4("start", "zoom", "end"), touchstarting, touchfirst, touchending, touchDelay = 500, wheelDelay = 150, clickDistance2 = 0, tapDistance = 10;
  ...
  Gesture.prototype = {
    ...
    emit: function(type2) {
      var d = select_default7(this.that).datum();
      listeners.call(
        type2,
        this.that,
        new ZoomEvent(type2, {
  ...
  function wheeled(event, ...args) {
    if (!filter5.apply(this, arguments)) return;
    var g = gesture(this, args).event(event), t = this.__zoom, k2 = Math.max(scaleExtent[0], Math.min(scaleExtent[1], t.k * Math.pow(2, wheelDelta.apply(this, arguments)))), p = pointer_default3(event);
    if (g.wheel) {
  ...
  function mousedowned(event, ...args) {
    ...
    var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v = select_default7(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default3(event, currentTarget), x06 = event.clientX, y06 = event.clientY;
    nodrag_default2(event.view);
    ...
    function mousemoved(event2) {
      ...
      g.event(event2).zoom("mouse", constrain(translate(g.that.__zoom, g.mouse[0] = pointer_default3(event2, currentTarget), g.mouse[1]), g.extent, translateExtent));
    }
  ...
  function dblclicked(event, ...args) {
    if (!filter5.apply(this, arguments)) return;
    var t03 = this.__zoom, p02 = pointer_default3(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t03.invert(p02), k1 = t03.k * (event.shiftKey ? 0.5 : 2), t13 = constrain(translate(scale(t03, k1), p02, p1), extent2.apply(this, args), translateExtent);
    noevent_default4(event);
    if (duration > 0) select_default7(this).transition().duration(duration).call(schedule, t13, p02, event);
    else select_default7(this).call(zoom.transform, t13, p02, event);
  }
  function touchstarted(event, ...args) {
    ...
    nopropagation4(event);
    for (i = 0; i < n; ++i) {
      t = touches[i], p = pointer_default3(t, this);
  ...
  function touchended(event, ...args) {
    ...
    if (g.touch0) g.touch0[1] = this.__zoom.invert(g.touch0[0]);
      ...
      g.end();
      if (g.taps === 2) {
        t = pointer_default3(t, this);
        if (Math.hypot(touchfirst[0] - t[0], touchfirst[1] - t[1]) < tapDistance) {
          var p = select_default7(this).on("dblclick.zoom");
  ...
  zoom.extent = function(_) {
    return arguments.length ? (extent2 = typeof _ === "function" ? _ : constant_default14([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom) : extent2;
  };
...
export {
  ...
  minIndex,
  mode,
  namespace_default3 as namespace,
  ...
  select_default7 as select,
  selectAll_default7 as selectAll,
  selection_default4 as selection,
  selector_default3 as selector,
  selectorAll_default3 as selectorAll,
